		...
		<div id="panel-1" class="panel panel-default mypanel">
			<div class="panel-heading">
				<span class="title elipsis">
					<strong>Active Users</strong> <!-- panel title -->
			...
			<div class="panel-body ">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
						...
						$sql=mysqli_query($db,"SELECT t1.uid as ttid,t1.*,t2.*,t3.parent_id,t3.sponsor_id,t4.first_name as pfname,t4.last_name as plname,t5.uname as puname,ub.bank_name,ub.acnumber from user_id t1 LEFT join user_detail t2 on t1.uid =t2.uid LEFT join user_bank ub on t1.uid=ub.uid join pairing t3 on t1.uid=t3.uid left join user_detail t4 on t3.sponsor_id=t4.uid left join user_id t5 on t3.sponsor_id=t5.uid where t1.role = 'user' AND t3.is_active=1 order by t1.uid");
