                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                            ...
                            <tr>
                               ...
                               <!--  <th  class="">Direct Sponsor Bonust</th>
                            ...
                            <?php
                            $i = 1;
                            $myquery = "SELECT p.*, t1.uname, t1.uid as ttid, t2.first_name, t2.last_name, t2.pan_no, t3.* FROM payout p LEFT JOIN user_id t1 on p.uid=t1.uid JOIN user_bank t3 on t1.uid =t3.uid JOIN user_detail t2 on t1.uid =t2.uid where p.cleared=1 and t1.uid!=1 and (p.gtb > 0)";
                            ...
                            ?>
                                <tr class="odd gradeX">
                                    ...
                                    <!-- <td><?php echo $row['dsb'];?></td>
                                    <td><?php echo $row['eb'];?></td>
                                    <td><?php echo $row['db'];?></td>
                                    <td><?php echo $row['sdb'];?></td>
                                    <td><?php echo $row['gdb'];?></td>
                                    <td><?php echo $row['ddb'];?></td>
