            ...
            <div id="panel-1" class="panel panel-default">
                <div class="panel-heading">
                    <span class="title elipsis">
                        <strong>Generated Rank Payout</strong> <!-- panel title -->
                        <!-- <a href="exportexcel" class="btn btn-success btn-xs pull-right"><i class = "fa fa-file"></i> Export Bulk</a>-->
                        <a href="neft_rank" class="btn btn-success btn-xs pull-right"><i class = "fa fa-file"></i> Export NEFT</a>
                    </span>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                            ...
                            while($row = mysqli_fetch_assoc($sql))
                            {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <input type="button" class="btn btn-success btn-xs PayoutMarkAsPaid_rank" id="makepayment" data-id="<?php echo $row['ttid'];?>"  value="Mark As Paid"/>
