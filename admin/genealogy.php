	...
	<div id="content" class="padding-20">
		...
		<div class="col-md-12">
			<div class="pan-container">
				<div id='treeview-pan' class='pan-wrap' style="transform: matrix(1, 0, 0, 1, 319, 21); backface-visibility: hidden; transform-origin: 50% 50% 0px; cursor: move; transition: none 0s ease 0s;">
		...
		$q1 = mysqli_fetch_assoc(mysqli_query($db,"SELECT t1.*,t2.* from user_id t1 LEFT join user_detail t2 on t1.uid = t2.uid and t1.uid = $mlmid"));
		?>		   
	            ...
	            <div>
	                ...
	                <div class='mypopup mypopup<?php echo $q1["paired"]; ?>'>
	                    <div class='col-md-12 plan-info'>
	                        ...
	                        <div class="col-md-12">
	                        	Nodes : <?php echo isset($total_child_count)?$total_child_count:0; ?>
	                        </div>
	                        <div class='clearfix'></div>
	                    </div>
	                    <!-- <div class='col-md-12 invest-info'>
	                        <div class='col-md-6 linfest'>
	                        	<strong>Left Business</strong><br>
	                            <?php echo $left_user_business; ?>
	                        </div>
	                        <div class='col-md-6'>
	                        	<strong>Right Business</strong><br>
	                            <?php echo $right_user_business; ?>
	                        </div>
	                        <div class='clearfix'></div>
	                    </div>
	                     <div class='col-md-12 invest-info'>
		                            ...
		                            <li data-id='".$l1["paired"]."' >
		                                <a href='javascript:void(0);' ".$onclick." ".$unpay.">
		                                    <div class='tree-user'><div ".$unpay.">
		                                        ";
		                                        if($l1["gender"]=="male"){ echo "<img src='../assets/images/male.png' class='user-icon'>"; }else{ echo "<img src='../assets/images/female.png' class='user-icon'>";}  
		                                        ...
		                                        <div class='col-md-12 plan-info'>
				                                        ...
				                                        /*<div class='col-md-12 invest-info'>
									                        <div class='col-md-6 linfest'>
									                        	<strong>Left Business</strong><br>".$left_user_business1."
									                        </div>
									                        <div class='col-md-6'>
									                        	<strong>Right Business</strong><br>".$right_user_business1."
									                        </div>
									                        <div class='clearfix'></div>
									                    </div>
				                                        <div class='col-md-12 invest-info'>
			                                            ...
			                                            <li data-id='".$l["paired"]."' >
			                                                <a href='javascript:void(0);' ".$onclick." ".$unpay.">
			                                                    <div class='tree-user'><div ".$unpay.">";
			                                                        ...
			                                                        /*<div class='col-md-12 invest-info'>
												                        <div class='col-md-6 linfest'>
												                        	<strong>Left Business</strong><br>".$left_user_business2."
												                        </div>
												                        <div class='col-md-6'>
												                        	<strong>Right Business</strong><br>".$right_user_business2."
												                        </div>
												                        <div class='clearfix'></div>
												                    </div>
			                                                        <div class='col-md-12 invest-info'>
												                        <div class='col-md-6 linfest'>
												                        	<strong>Left Blue Count</strong><br>".$left_red_id2."
												                        </div>
												                        <div class='col-md-6'>
												                        	<strong>Right Blue Count</strong><br>".$right_red_id2."
												                        </div>
												                        <div class='clearfix'></div>
												                    </div>
												                    ...
												                    <div class='col-md-12 nodes-info'>
												                        <div class='col-md-6 linfest'>
												                        	<strong>Left Green Count</strong><br>".$left_green_id2."
												                        </div>
												                        <div class='col-md-6'>
												                        	<strong>Right Green Count</strong><br>".$right_green_id2."
												                        </div>
												                        <div class='clearfix'></div>
												                    </div>*/
			                                                        echo "<div class = 'clearfix'></div>
