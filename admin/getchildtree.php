...
if(mysqli_num_rows($query)>0)
{
	...
	$query1 = mysqli_query( $db, "SELECT t1.*,t3.* from user_id t1 left join pairing t3 on t1.uid=t3.uid WHERE t1.uid = '$parent_id'" ) or die(mysqli_error($db));
	if(mysqli_num_rows($query1)>0)
	{
                        ...
                        <div class='col-md-12 text-center'>
                          ...
                          Total Purchase : <?php echo  GetUserTotalPurchase($db,$q1['uid']); ?><br><br>
                           <div class='col-md-6'>
    					  	  ...
    					  	  Total Left Team Active : <?= getGreenId(GetUserByPos($db,$q1['uid'],'L')); ?>
    					  	</div>
    					  	<div class='col-md-6'>
    					  	  Total Right Team : <?= count(GetUserByPos($db,$q1['uid'],'R')); ?><br>
    					  	  Total Right Team Active : <?= getGreenId(GetUserByPos($db,$q1['uid'],'R')); ?>
    					  	</div>
                        </div>
                    </div>
                    </div>
                                            ...
                                            <div class='tree-user'><div ".$unpay.">
                                                ...
                                                <div class='col-md-12 plan-info'>
                                                    <div class='col-md-12 text-center'>
                                                          ...
                                                          Total Bv :".GetUserTotalBV($db,$l1['uid'])."<br>
                                                          Total PV :".GetUserTotalPV($db,$l1['uid'])."<br>
                                                          Total Purchase :".GetUserTotalPurchase($db,$l1['uid'])."<br><br>";?>
                                                           <div class='col-md-6'>
                                    					  	  Total Left Team : <?= count(GetUserByPos($db,$l1['uid'],'L')); ?><br>
                                    					  	  Total Left Team Active : <?= getGreenId(GetUserByPos($db,$l1['uid'],'L')); ?>
                                    					  	</div>
                                    					  	<div class='col-md-6'>
                                    					  	  Total Right Team : <?= count(GetUserByPos($db,$l1['uid'],'R')); ?><br>
                                    					  	  Total Right Team Active : <?= getGreenId(GetUserByPos($db,$l1['uid'],'R')); ?>
                                    					  	</div>
                                                      <?php echo"</div>
                                                      </div>
                                                </div>
                                                                ...
                                                                <div class='tree-user'><div ".$unpay.">";
                                                                    ...
                                                                    <div class='col-md-12 plan-info'>   
                                                                        <div class='col-md-12 text-center'>
                                                                              ...
                                                                              Total Bv :".GetUserTotalBV($db,$l['uid'])."<br>
                                                                              Total PV :".GetUserTotalPV($db,$l['uid'])."<br>
                                                                              Total Purchase :".GetUserTotalPurchase($db,$l['uid'])."<br><br>";?>
                                                                               <div class='col-md-6'>
                                                        					  	  Total Left Team : <?= count(GetUserByPos($db,$l['uid'],'L')); ?><br>
                                                        					  	  Total Left Team Active : <?= getGreenId(GetUserByPos($db,$l['uid'],'L')); ?>
                                                        					  	</div>
                                                        					  	<div class='col-md-6'>
                                                        					  	  Total Right Team : <?= count(GetUserByPos($db,$l['uid'],'R')); ?><br>
                                                        					  	  Total Right Team Active : <?= getGreenId(GetUserByPos($db,$l['uid'],'R')); ?>
                                                        					  	</div>
                                                                         <?php echo"</div>
                                                                          </div>
                                                                    </div>
