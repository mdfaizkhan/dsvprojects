                  ...
                  <div class="sidebar-single">
                     ...
                     <div class="sidebar-body">
                        <ul class="sidebar-category">
                          <li><a href="javascript:void(0);" class="CategoryFilter " data-id="">All</a></li>
                           <?php
                              $sr=1;
                              ...
                              {
                              ?>
                           <li> <a href="javascript:void(0);" class="CategoryFilter" data-id="<?php echo $r1["cat_id"]; ?>"><?php echo $r1["cat_name"]; ?></a></li>
                           <?php } } ?>
            ...
            <div class="col-lg-9 order-1 order-lg-2">
               <div class="shop-product-wrapper">
                  ...
                  <div class="shop-product-wrap grid-view row">
                     <?php
                        $req='';
                            $sql="SELECT t1.*,t2.cat_name FROM products t1 left join product_category t2 on t1.cat_id=t2.cat_id order by product_id";
