    ...
    <div id="ContentPlaceHolder1_Panel1" style=" padding:2px;">
        ...
        <table id="ContentPlaceHolder1_Table1" border="0" width="100%">
            <tbody>
                ...
                <tr>
                    <td align="left" colspan="2" style="padding-left: 30px;"><h4 class="style3">FRENTIC RETAIL & MARKETING PVT.LTD.<br>
                ...
                <tr>
                    <td style="text-align: justify" colspan="2">
                        <p class="MsoNormal">
                            <span lang="EN-US">Well begun is half done .I’d like to welcome you to FRENTIC. We are glad that you have joined us
                        <o:p></o:p></span></p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: justify" colspan="2">
                        <p class="MsoNormal">
                            <span lang="EN-US">We believe that this letter finds you mutually excited about your new opportunity with FRENTIC</span></p>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: justify" colspan="2">
                ...
                <tr>
                    <td style="text-align: left" colspan="2">
                        <p class="MsoNormal">
                            <span lang="EN-US">FRENTIC RETAIL & MARKETING PVT.LTD.</span></p>
                    </td>
                </tr>
                <tr>
                    <td align="left" colspan="2">&nbsp;</td>
                ...
                <tr>
                    <td style="text-align: left" colspan="2">
                        <p class="MsoNormal">
                            <span lang="EN-US">FRENTIC RETAIL & MARKETING PVT.LTD., #404, 4th Floor,Pragati Shopping Center,Daftary Road, Near Railway Station,Malad (East), Mumbai - 400097, Maharashtra, E-mail :info@miwellness.in, WebSite : www.miwellness.in</span></p>
                    </td>
                </tr>
                <tr>
                    <td align="left" colspan="2">&nbsp;</td>
