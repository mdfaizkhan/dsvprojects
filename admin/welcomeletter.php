...
<!-- <div style="border: 5px solid #006699;padding: 5px;"> -->
    <TITLE>VARIETIZ PHARMA PVT.LTD.</TITLE>
<!--<div style="padding: 50px;width:70%;padding-left:15%;padding-right:15%; " class="test">-->
    ...
    padding-top: 180px;>
            <tbody>
                ...
                <tr>
                    <td style="text-align: left" colspan="2">
                        <p class="MsoNormal">
                            <span lang="EN-US">VARIETIZ PHARMA PVT.LTD., 
                            <!-- #404, 4th Floor,Pragati Shopping Center,Daftary Road, Near Railway Station,Malad (East), Mumbai - 400097, Maharashtra, E-mail :info@miwellness.in, WebSite : www.miwellness.in --></span></p>
                    </td>
                </tr>
                <tr>
                    <td align="left" colspan="2">&nbsp;</td>
