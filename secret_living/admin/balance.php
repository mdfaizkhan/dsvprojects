            ...
            <div class="panel-body ">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                        ...
                        $i = 1;
                        $total_amount=0;
                        $sql=mysqli_query($db,"SELECT t1.*,t2.uname,t3.first_name,t3.last_name FROM bal_req t1 left join user_id t2 on t1.uid=t2.uid left join user_detail t3 on t1.uid=t3.uid  order by t1.req_id ") or die(mysqli_error($db));
                        ...
                        ?>
                            <tr class="odd gradeX">
                                ...
                                {
                                    ?>
                                        <input type="button" class="btn btn-success btn-xs ReqMarkAsPaid" data-id="<?php echo $row['req_id'];?>"  value="Confirm"/> 
                                        <input type="button" class="btn btn-danger btn-xs RejectReq" data-id="<?php echo $row['req_id'];?>"  value="Reject"/>
                                    <?php } ?> 
                                </td>
                            </tr>
                        <?php
