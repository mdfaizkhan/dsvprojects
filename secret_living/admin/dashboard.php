...
$pvs=mysqli_query($db,"select left_pv,right_pv,rright_pv,rleft_pv from child_counter where uid=1");
...
$Joinings = mysqli_query($db,"select year(register_date),month(register_date),COUNT(*) from `user_id` WHERE register_date group by month(register_date)");
 ...
 $m_name=json_encode($m_name);
  $order = mysqli_query($db,"select count(user) as count from `checkout`");
                        ...
                        <div class="box">
                           <a href="#">
                              <div class="panel shadow padder-v item lg-panel">
                                 ...
                                 <div class="h1  font-thin h1"> <?php echo isset($user['balance'])?$user['balance']:0; ?></div>
                              </div>
                           </a>
                        </div>
                     </div>
                           ...
                           <a href="order">
                              <div class="panel shadow padder-v item lg-panel">
                                 ...
                                 <div class="h1  font-thin h1" id="total_commission">
                                    <?php echo isset($ordercounts['count'])?$ordercounts['count']:0 ?>
                                 </div>
                              </div>
                           </a>
                        </div>
                        ...
                        <div class="box2">
                           ...
                           <a href="">
                              <div class="panel shadow padder-v item lg-panel">
                                 ...
                                 <div class=" font-thin h1 block1" id="total_payout"> <?php echo $left_pv ?> </div>
                              </div>
                           </a>
                        </div>
                     </div>
                        ...
                        <div class="box3">
                           <a href="">
                              <div class="panel shadow padder-v item lg-panel">
                                 ...
                                 <div class="font-thin  h1" id="mail_total"><?php echo $right_pv; ?></div>
                              </div>
                           </a>
                        </div>
                     </div>
                  ...
                  <div class="user-det">
                     <div class=" grid  grid-four  grid_three">
                        <div class="sponsor-details vertical_line">
                           ...
                           <div class="extra_data">Itself(Admin)</div>
                        </div>
                        <div class="sponsor-details vertical_line">
            ...
            <div class="col wrapper ">
                <div class="dropdown pull-right">
                    <div data-toggle="dropdown" aria-expanded="false">
                        <i class="fa fa-filter text-info" aria-hidden="true"></i>
                    </div>
                   <!--  <ul class="dropdown-menu dropdown-menu_right" id="joinings_graph">
                        <li class="">
                            <a id="yearly_joining_graph" href="javascript:void(0);">Year</a>
                        </li>
                        <li class="active">
                            <a id="monthly_joining_graph" href="javascript:void(0);"> Month</a>
                        </li>
                        <li>
                            <a id="daily_joining_graph" href="javascript:void(0);"> Day</a>
                        </li>
                    </ul> -->
                </div>
                                       ...
                                       <td valign="v-middle" class="grid-1">
                                          <div class="col-lg-12">
                                             ...
                                             <div class="col-lg-10 col-xs-10 padding-zero">
                                                ...
                                                <div class="col-lg-6 text-center padding-zero member-package-Center">
                                                   <div class="member-package">
