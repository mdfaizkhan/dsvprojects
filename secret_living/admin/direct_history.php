					...
					<table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
						<thead>
							<tr>
	                            ...
	                            <th  class="">User</th>
	                            <th  class="">Direct Sponsor Commission</th>
	                            <th  class="">Date</th>
                        ...
                        {
                        	$i=1;
							$sql = mysqli_query($db,"SELECT t1.*,t2.uname as username FROM `payout` t1 left join user_id t2 on t1.uid=t2.uid where t1.uid='$user_id' order by t1.id desc");
		                    ...
		                    ?>
		                        <tr class="odd gradeX">
		                           ...
		                           <td><?php echo $row['direct_sponsor_comm'];?></td>
		                            ...
		                            <td><?php  echo isset($row['cleared_date'])?modifyDate($row['cleared_date']):'Not Cleared'; ?></td>									
		                            <td>
		                             <?php if($row['cleared']==0){
