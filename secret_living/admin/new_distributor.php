			...
			<div class="panel-body ">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
						...
						<?php
						    $i = 1;
				            $sql1 = "SELECT t1.*,t2.*,t3.*,t4.uname as suname from pairing t1 join user_id t2 on t1.uid = t2.uid join user_detail t3 on t1.uid=t3.uid left join user_id t4 on t1.sponsor_id=t4.uid WHERE t1.uid!=$mlmid";
