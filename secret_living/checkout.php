                                ...
                                <?php
                                  ...
                                  <div class="col-md-6">
                                    <div class="single-input-item">
                                      ...
                                      <select name="fid" id="fid" class="form-control select2 frSelect">
                     ...
                     <div class="order-summary-content">
                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 if(isset($_SESSION['mlmid']))
                                  {
                                    $uid=$_SESSION['mlmid'];
                                    $q1=mysqli_query($db,"SELECT t1.*,t2.bv as pbv FROM cart t1 left join products t2 on t1.product_id=t2.product_id WHERE t1.uid='$uid' and t1.transaction_id IS null");
                                  }
                                  else if(isset($_SESSION['franchiseid']))
                                  {
                                    $fid=$_SESSION['franchiseid'];
                                    $q1=mysqli_query($db,"SELECT t1.*,t2.bv as pbv FROM cart t1 left join products t2 on t1.product_id=t2.product_id WHERE t1.fid='$fid' and t1.transaction_id IS null");
                                  }
                                 ...
                                 <tr>
                                    ...
                                    <td>₹<?=$r1['price']; ?> <?php echo "---".$r1['pbv']."---".$bv; ?></td>
                                 </tr>
                              <?php } ?>
                              </tbody>
                              <tfoot>
                        ...
                        <div class="order-payment-method">
                           ...
                           <div class="summary-footer-area">
                              ...
                              <input type="hidden" name="bv" value="<?=$userbv; ?>" id="userbv">
                              ...
                              <button type="button" class="btn btn__bg" data-form="OrderNow" id="OrderNowBtn">Place Ordear</button>
