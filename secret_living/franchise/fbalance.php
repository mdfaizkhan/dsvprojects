...
$data=mysqli_fetch_assoc(mysqli_query($db,"SELECT balance FROM `franchise` where id='$mlmid'"));
?>
<section id="middle">
        ...
        <div id="panel-1" class="panel panel-default mypanel">
            <div class="panel-heading">
                <span class="title elipsis">
                    <strong>Waallet Balance ₹<?=$data['balance']; ?></strong>
                    <a class="btn btn-xs btn-info pull-right" href="addfbal" title="Add Wallet Balance Request" ><i class="fa fa-plus white"> Add</i></a>
                </span>
            </div>
            <!-- panel content -->
            ...
            <div class="panel-body ">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                        ...
                        <?php
                        $i = 1;
                        $sql=mysqli_query($db,"SELECT t1.*,t2.uname FROM fbal_req t1 left join franchise t2 on t1.fid=t2.id WHERE t1.fid='$mlmid' order by t1.req_id ") or die(mysqli_error($db));
                        ...
                        ?>
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <?php if($row['status'] == 0)
                                    { ?>
                                  <a href="javascript:void(0);" title="Delete Request" class="DeleteFWBReq btn btn-danger btn-xs" data-id="<?php echo $row['req_id'];?>"><i class="fa fa-trash"></i> Delete</a>
                              <?php } ?>
                                </td>
                            </tr>
                        <?php
