            ...
            <div class="panel-body ">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                        ...
                        <?php
                        $i = 1;
                        $sql=mysqli_query($db,"SELECT t1.*,t2.uname,t3.first_name,t3.last_name FROM checkout t1 left join user_id t2 on t1.uid=t2.uid left join user_detail t3 on t1.uid=t3.uid where t1.fid='$mlmid' order by t1.id ") or die(mysqli_error($db));
                        ...
                        ?>
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    ...
                                    { ?>
                                        <input type="button" class="btn btn-success btn-xs"   value="Dispatched" disabled />
                                        
                                    <?php } else if(isset($row['pay_user']) && $row['pay_user']==0) { ?>
                                        <input type="button" class="btn btn-info btn-xs DispatchOrder" data-id="<?php echo $row['id'];?>"  value="Dispatch"/>
