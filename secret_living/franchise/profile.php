...
<?php
$q1 = mysqli_fetch_assoc($db->query("select * from franchise where id = '$mlmid'"));
$q2 = mysqli_fetch_assoc($db->query("select * from franchise where id = '$mlmid'"));
?>
<style type="text/css">
							...
							<div class="col-xs-12">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter Name" name="name" value = "<?php echo $q1["name"];?>" />
									</div>
								...
								<!-- 	<div class="form-group">
									...
									<input type="hidden" name="info" value="franchise">
						...
						<form id="UpdateProfile4" role="form" action="" method="post">
							<div class="col-xs-12">
								<div class="col-md-12">
									...
									<div class="form-group">
										<label class="control-label">Adhar Card(Front)</label>
									...
									<div class="form-group">
										<label class="control-label">Adhar Card(Back)</label>
