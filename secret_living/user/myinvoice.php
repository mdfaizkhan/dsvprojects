                    ...
                    <div class="panel-body" id="PrintArea">
                        ...
                        <div class="row clerfix">
                            ...
                            <div class="col-md-3 col-sm-12 text-left" style="border: 1px solid #ddd;margin-top:30px;">
                                <br>
                               <h5><text>Invoice No. : <?php echo "SLINV".leftpad($data1['id'],6);?></text>
                                <br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               /* if(isset($data1['fid']) && !empty($data1['fid'])){ 
                                                echo "Rs.". isset($r['fp'])?$r['fp']:'';
                                                $prd_price=$r['fp'];
                                              }
                                              else */
                        ...
                        <div class="row clerfix"><br><br><br>
                            <div class="col-md-12 col-sm-12 text-left">Note: Unless otherwise stated, tax on this invoice is not payable under reverse charge for Secret Living.
                            </div>
                        </div>
                    </div>
                </div>
